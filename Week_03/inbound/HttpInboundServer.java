...
public class HttpInboundServer {
    ...
    public HttpInboundServer(int port, String proxyServer) {
        this.port=port;
        this.proxyServer = proxyServer; //可以传多个
    }
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.option(ChannelOption.SO_BACKLOG, 128)//保持连接状态 个数
                    ...
                    .childOption(ChannelOption.SO_KEEPALIVE, true)//boss ->worker层级
                    .option(ChannelOption.ALLOCATOR, PooledByteBufAllocator.DEFAULT);//byteBuffer 内存池，不用重复申请
